...
// マクロ定義
//=========================
#define DEF_SIZE_STATIC D3DXVECTOR3(90.0f * 1.5f, 90.0f, 0.0f)				//デフォルトサイズ
...
public:
	...
	static CPress_Enter *Create(const D3DXVECTOR3 pos, const D3DXVECTOR3 size = DEF_SIZE_STATIC, const D3DXVECTOR3 rot = DEF_VEC3);		//生成
